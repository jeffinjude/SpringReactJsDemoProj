...
@Controller
public class UpdateUserDetails implements ApplicationContextAware {
	...
	protected ModelAndView saveUserDetails(@ModelAttribute("userDetails") UserDetails userDetails) throws Exception {
		...
		userDetailsDao.updateData(userDetails.getUserId(), userDetails.getUserName(), userDetails.getPhoneNumber());
		
		List<UserDetails> fetchedUserDetails = userDetailsDao.fetchAllUserDetails();
		modelAndView.addObject("message", "Successfully updated the data!");
